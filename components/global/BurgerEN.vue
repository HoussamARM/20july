  ...
  <nav class="z-50 flex h-10 text-black bg-transparent zind">
    <div class="flex items-center">
      <button class="z-40 mr-2" aria-label="Open Menu" @click="drawer">
        ...
        <div
          v-else
          class="z-10 mt-2 text-2xl text-white cursor-pointer hover:text-gray-400"
        >
    ...
    <aside
      ...
      class="fixed top-0 left-0 z-30 h-full overflow-auto transition-all duration-700 ease-in-out transform bg-white w-80"
    >
      <div class="flex flex-col pr-5">
        ...
        >
          <div
            ...
            class="flex items-center justify-between w-full mb-3 text-lg cursor-pointer hover:text-gray-600"
          >
            <p>
          ...
          >
              ...
              <img
                :class="sectionMenu == 'family' ? ' rotate-0 ' : 'rotate-90 '"
                class="w-5 h-5 transform"
                src="/arrow.svg"
                alt=""
              />
            ...
            >
              <div
                v-if="sectionMenu == 'family'"
                class="flex flex-col w-full pt-1 pb-3 ml-8 space-y-1"
              >
                <nuxt-link :to="localePath('/chapterthree#family1')">
                  <p
                    @click="toggleMenu()"
                    class="text-gray-600 hover:text-black"
                  >
                    <span v-if="this.$i18n.locale === 'ar'">صبحية مع هالة</span>
                    <span v-if="this.$i18n.locale === 'en'">Hala</span>
                  </p>
                </nuxt-link>

                <nuxt-link :to="localePath('/chapterthree#family12')">
                  <p
                    @click="toggleMenu()"
                    class="text-gray-600 hover:text-black"
                  >
                    <span v-if="this.$i18n.locale === 'ar'">مريول أزرق</span>
                    <span v-if="this.$i18n.locale === 'en'">Blue Apron</span>
                  </p>
                </nuxt-link>

                <nuxt-link :to="localePath('/chapterthree#family2')">
                  <p
                    @click="toggleMenu()"
                    class="text-gray-600 hover:text-black"
                  >
                    <span v-if="this.$i18n.locale === 'ar'"> مونولغ</span>
                    <span v-if="this.$i18n.locale === 'en'">Monologue</span>
                  </p>
                </nuxt-link>

                <nuxt-link :to="localePath('/chapterthree#family3')">
                  <p
                    @click="toggleMenu()"
                    class="text-gray-600 hover:text-black"
                  >
                    <span v-if="this.$i18n.locale === 'ar'">برنار</span>
                    <span v-if="this.$i18n.locale === 'en'">Bernard</span>
                  </p>
                </nuxt-link>

                <nuxt-link :to="localePath('/chapterthree#family4')">
                  <p
                    @click="toggleMenu()"
                    class="text-gray-600 hover:text-black"
                  >
                    <span v-if="this.$i18n.locale === 'ar'">تأسيس العائلة</span>
                    <span v-if="this.$i18n.locale === 'en'"
                      >Family Foundation</span
                    >
                  </p>
                </nuxt-link>
              </div>
        ...
        <div
          @click="isOpen = false"
          class="flex flex-col content-start justify-end w-full mt-12 mb-5 cursor-pointer"
        >
          <nuxt-link
            class="ml-8 border-b-2 border-black"
            :to="localePath('/about')"
          >
            <p @click="toggleMenu()">
        ...
        <div
          @click="isOpen = false"
          class="flex flex-col content-start justify-end w-full mb-5 cursor-pointer"
        >
          <nuxt-link
            class="ml-8 border-b-2 border-black"
            :to="localePath('/team')"
