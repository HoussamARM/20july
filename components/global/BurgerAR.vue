              ...
              >
                ...
                <nuxt-link :to="localePath('/chapterthree#family2')">
                  <p
                    ...
                    class="text-gray-600 hover:text-black"
                  >
                    <span v-if="this.$i18n.locale === 'ar'"> المريول الأزرق
</span>
                ...
                <nuxt-link :to="localePath('/chapterthree#family3')">
                  <p
                    ...
                    class="text-gray-600 hover:text-black"
                  >
                    <span v-if="this.$i18n.locale === 'ar'"> مونولج الأقدار</span>
                    <span v-if="this.$i18n.locale === 'en'">Monologue</span>
                  </p>
                </nuxt-link>

                <nuxt-link :to="localePath('/chapterthree#family٤')">
                  <p
                    @click="toggleMenu()"
                    class="text-gray-600 hover:text-black"
                  >
                ...
                <nuxt-link :to="localePath('/chapterthree#family5')">
                  <p
                    @click="toggleMenu()"
                    class="text-gray-600 hover:text-black"
                  >
                    <span v-if="this.$i18n.locale === 'ar'">تأسيس الأسرة</span>
                    <span v-if="this.$i18n.locale === 'en'"
                      >Establishing the Family</span
                    >
                  </p>
                </nuxt-link>
              </div>
