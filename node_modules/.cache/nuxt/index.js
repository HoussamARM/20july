...
import nuxt_plugin_plugin_0edef653 from 'nuxt_plugin_plugin_0edef653' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_index_76066196 from 'nuxt_plugin_index_76066196' // Source: ./components/index.js (mode: 'all')
import nuxt_plugin_pluginutils_37d3d11c from 'nuxt_plugin_pluginutils_37d3d11c' // Source: ./nuxt-i18n/plugin.utils.js (mode: 'all')
import nuxt_plugin_pluginrouting_2622df86 from 'nuxt_plugin_pluginrouting_2622df86' // Source: ./nuxt-i18n/plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_3fbd8c52 from 'nuxt_plugin_pluginmain_3fbd8c52' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
import nuxt_plugin_pluginclient_0c87604f from 'nuxt_plugin_pluginclient_0c87604f' // Source: ./content/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_7240d1d7 from 'nuxt_plugin_pluginserver_7240d1d7' // Source: ./content/plugin.server.js (mode: 'server')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_0edef653 === 'function') {
    await nuxt_plugin_plugin_0edef653(app.context, inject)
  }

  if (typeof nuxt_plugin_index_76066196 === 'function') {
    await nuxt_plugin_index_76066196(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginutils_37d3d11c === 'function') {
    await nuxt_plugin_pluginutils_37d3d11c(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_2622df86 === 'function') {
    await nuxt_plugin_pluginrouting_2622df86(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_3fbd8c52 === 'function') {
    await nuxt_plugin_pluginmain_3fbd8c52(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_0c87604f === 'function') {
    await nuxt_plugin_pluginclient_0c87604f(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_7240d1d7 === 'function') {
    await nuxt_plugin_pluginserver_7240d1d7(app.context, inject)
  }
