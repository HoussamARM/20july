  ...
  _createClass(ImageMap, [{
    ...
    value: function update() {
      ...
      for (var i = 0; i < imgs.length; i++) {
        ...
        newImg.addEventListener(LOAD, this.handleImageLoad(img.offsetWidth, 4 * img.offsetWidth));
        else
    ...
    value: function handleImageLoad() {
      ...
      var offsetHeight = arguments.length > 0 && arguments[0] !== undefined ? arguments[1] : 0;
