        ...
        <div class="modal__body">
          ...
          >
            ...
            <video
              ...
              loop
              muted
              :videoSubEN="videoENurl"
              :videoSubAR="videoARurl"
            >
              ...
              <track
                ...
                default
              />
              <!-- <track label="English" kind="subtitles" srclang="en" src="/Images/c1/sectionFour/w1en.vtt" default> -->
...
export default {
  ...
  methods: {
    closeModal() {
      this.show = false
      this.Indiaaudio = true
      this.Indiarepeat = false
    ...
    async openModal(youtubeID) {
      ...
      // this.videoENurl = '/Images/c1/sectionFour/' + youtubeID + 'en.vtt'
      //  this.videoARurl = '/Images/c1/sectionFour/' + youtubeID + 'ar.vtt'
