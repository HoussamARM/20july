...
import nuxt_plugin_plugin_1418bed7 from 'nuxt_plugin_plugin_1418bed7' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_index_6def7892 from 'nuxt_plugin_index_6def7892' // Source: ./components/index.js (mode: 'all')
import nuxt_plugin_pluginutils_64f9016e from 'nuxt_plugin_pluginutils_64f9016e' // Source: ./nuxt-i18n/plugin.utils.js (mode: 'all')
import nuxt_plugin_pluginrouting_7e82298e from 'nuxt_plugin_pluginrouting_7e82298e' // Source: ./nuxt-i18n/plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_0a1772d6 from 'nuxt_plugin_pluginmain_0a1772d6' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
import nuxt_plugin_pluginclient_523d725a from 'nuxt_plugin_pluginclient_523d725a' // Source: ./content/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_3c9ab85b from 'nuxt_plugin_pluginserver_3c9ab85b' // Source: ./content/plugin.server.js (mode: 'server')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_1418bed7 === 'function') {
    await nuxt_plugin_plugin_1418bed7(app.context, inject)
  }

  if (typeof nuxt_plugin_index_6def7892 === 'function') {
    await nuxt_plugin_index_6def7892(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginutils_64f9016e === 'function') {
    await nuxt_plugin_pluginutils_64f9016e(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_7e82298e === 'function') {
    await nuxt_plugin_pluginrouting_7e82298e(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_0a1772d6 === 'function') {
    await nuxt_plugin_pluginmain_0a1772d6(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_523d725a === 'function') {
    await nuxt_plugin_pluginclient_523d725a(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_3c9ab85b === 'function') {
    await nuxt_plugin_pluginserver_3c9ab85b(app.context, inject)
  }
